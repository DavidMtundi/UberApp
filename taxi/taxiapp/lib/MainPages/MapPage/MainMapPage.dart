...
import 'package:taxiapp/MainPages/utils/Maputils.dart';
...
class MainPageMapScreen extends StatefulWidget {
  final DetailsResult? startPosition;
  final DetailsResult? endPosition;

  const MainPageMapScreen({Key? key, this.startPosition, this.endPosition})
      : super(key: key);
  @override
  _MainPageMapScreenState createState() => _MainPageMapScreenState();
}

class _MainPageMapScreenState extends State<MainPageMapScreen> {
