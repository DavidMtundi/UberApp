...
import 'package:uberdriver/screens/ride_request.dart';
import 'package:uberdriver/widgets/custom_text.dart';
import 'package:uberdriver/widgets/loading.dart';
import 'package:uberdriver/widgets/rider_draggable.dart';
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          ...
                          boxShadow: const [
                            BoxShadow(color: grey, blurRadius: 17)
                          ]),
                      child: Padding(
...
class MapScreen extends StatefulWidget {
  ...
  const MapScreen(this.scaffoldState);
